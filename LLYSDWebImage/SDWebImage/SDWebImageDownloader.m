...
didReceiveResponse:(NSURLResponse *)response
 completionHandler:(void (^)(NSURLSessionResponseDisposition disposition))completionHandler {
    ...
    NSLog(@"method = %@",dataTask.currentRequest.HTTPMethod);
    NSLog(@"request http header field = %@",dataTask.currentRequest.allHTTPHeaderFields);
    NSLog(@"respone http header field = %@",((NSHTTPURLResponse *)response).allHeaderFields);
    NSLog(@"url cache cachePolicy = %lu",(unsigned long)dataTask.currentRequest.cachePolicy);
